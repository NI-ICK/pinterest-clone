    ...
    {!loading &&
      <div className="pinPageBackground">
        <div className="pinContainer">
          <img src={`${process.env.URL}/public/pins/${pin.image}`} className='pinImg'/>
          <div className="pinDetails">
            ...
            <div className="pinUser"> 
              <img 
                src={pinUser.photo ? `${process.env.URL}/public/photos/${pinUser.photo}` : `${process.env.URL}/public/photos/noPhoto.jpg`}
              ...
              {comments ? (comments.map((comment, index) => (
                <div className="comment" key={index} >
                  <div className="commentContent">
                    <img
                      src={comment.user && comment.user.photo ? `${process.env.URL}/public/photos/${comment.user.photo}` : `${process.env.URL}/public/photos/noPhoto.jpg`}
                  ...
                  {comment.replies.map((reply, index) => (
                    <div className="reply" key={index}>
                      <img
                        src={reply.user.photo ? `${process.env.URL}/public/photos/${reply.user.photo}` : `${process.env.URL}/public/photos/noPhoto.jpg`}
