...
export function FormDataContextProvider({ children }) {
  ...
  const handleCreatePinSubmit = async () => {
    ...
    try {
      await axios.post(`${process.env.SITE_URL}/api/createPin`, updatedFormData, {
  ...
  const handleRegisterSubmit = async () => {
    try {
      const response = await axios.post(`${process.env.SITE_URL}/api/register`, formData.register, {
        withCredentials: true,
  ...
  const handleLoginSubmit = async () => {
    try {
      const response = await axios.post(`${process.env.SITE_URL}/api/login`, formData.login, { 
        withCredentials: true,
        headers: { 'Content-Type': 'application/json' }
      })
  ...
  const handleEditUserSubmit = async () => {
    ...
    try {
      await axios.put(`${process.env.SITE_URL}/api/editUser`, updatedFormData, {
        withCredentials: true,
        headers: { 'Content-Type': 'multipart/form-data' }
      })
    } catch (error) {
  ...
  const handleCommentSubmit = async () => {
    ...
    try {
      await axios.post(`${process.env.SITE_URL}/api/comment`, updatedFormData, {
        withCredentials: true,
        headers: { 'Content-Type': 'application/json' }
      })
    } catch (error) {
  ...
  const handleCreateCollectionSubmit = async (id) => {
    ...
    try {
      await axios.post(`${process.env.SITE_URL}/api/collections/create`, updatedFormData)
    } catch(error) {
